...
//картинки для этапов ниже
    kartinka_proto_to_sun: {
        ...
        infoRight: '<p> Примеры:</p> <p>V1647 Orionis</p>',
        temperature: '10-20K',
        light: '',
        time_slider: '123',
        cell1: '',
    ...
    kartinka_sun_to_rg1: {
        myImage: 'img/sun_type.jpg',
        mainLabel: 'Звезда солнечного типа',
        infoLeft: 'Звезда солнечного типа, звезда-аналог Солнца и двойник Солнца — это три категории звёзд, более или менее похожих на Солнце. Изучение этих звёзд весьма важно для лучшего понимания свойств Солнца, его уникальности или, наоборот, типичности среди других звёзд, а также возможности существования обитаемых планет у других звезд.',
        infoRight: '<p> Примеры:</p> <p> Тау Кита</p> <p> 40 Эридана A</p> <p> Солнце</p> <p>Дельта Павлина	</p>',
        temperature: '5778 K ',
        light: '3.75×1028 lm',
        cell1: '',
        cell2: '',
        ...
        draw: function () {
            var graphic = $('#graphic');
            graphic.empty();
            graphic.html("<img height ='440' src='img/img_etap/2r.jpg'>");
        }
    },
    kartinka_sun_to_rg2: {
        myImage: 'img/sun_type.jpg',
        ...
        draw: function () {
            var graphic = $('#graphic');
            graphic.empty();
            graphic.html("<img height ='440' src='img/img_etap/3.jpg'>");
        }
    },
    kartinka_sun_to_rg3: {
        myImage: 'img/sun_type.jpg',
        ...
        draw: function () {
            var graphic = $('#graphic');
            graphic.empty();
            graphic.html("<img height ='440' src='img/img_etap/4.jpg'>");
        }
    },
    kartinka_rd_to_pr: {
        myImage: 'img/red_giant_gif.gif',
        mainLabel: 'Красный гигант',
        infoLeft: 'Кра́сные гига́нты и сверхгига́нты — звёзды поздних спектральных классов с высокой светимостью и протяжёнными оболочками.',
        infoRight: '<p> Примеры:</p> <p>Mira</p> <p>Albireo</p> <p>4 Cassiopeiae</p>',
        temperature: '3000−5000K',
        light: ' 10^5-10^6 Lsol',
        cell1: '',
        cell2: '',
        ...
        draw: function () {
            var graphic = $('#graphic');
            graphic.empty();
            graphic.html("<img height ='440' src='img/img_etap/5.jpg'>");
        }
    },
    kartinka_rd_to_pr2: {
        myImage: 'img/red_giant_gif.gif',
        ...
        draw: function () {
            var graphic = $('#graphic');
            graphic.empty();
            graphic.html("<img height ='440' src='img/img_etap/6rr.jpg'>");
        }
    },
    kartinka_rd_to_pr3: {
        myImage: 'img/red_giant_gif.gif',
        ...
        draw: function () {
            var graphic = $('#graphic');
            graphic.empty();
            graphic.html("<img height ='440' src='img/img_etap/7.jpg'>");
        }
    }
};