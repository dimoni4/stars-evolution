...
WAGNER.Composer = function( renderer, settings ) {
	...
	this.vertexShadersPath = this.settings.vertexShadersPath || 'js/lib/supernova/vertex-shaders';
	this.fragmentShadersPath = this.settings.fragmentShadersPath || 'js/lib/supernova/vertex-shaders';
...
WAGNER.loadShader = function( file, callback ) {
	...
	var path;
	if( file.indexOf( '-vs.glsl' ) != -1 ) path = 'js/lib/supernova/vertex-shaders/';
	else path = 'js/lib/supernova/fragment-shaders/';
